...
CHANNEL_CONFIG_SCHEMAS: dict[str, ChannelConfigSchema] = {
    "telegram": ChannelConfigSchema(
        ...
        fields=[
            ConfigField(
                "token", "Bot Token", required=True, sensitive=True, description="Telegram bot token from @BotFather"
            ),
            ConfigField("allowedUsers", "Allowed Users", description="Comma-separated Telegram usernames"),
            ConfigField(
                "groupMode",
                "Group Mode",
                field_type="select",
    ...
    "discord": ChannelConfigSchema(
        ...
        fields=[
            ...
            ConfigField("guildId", "Server ID", description="Discord server (guild) ID"),
        ],
    ),
    "slack": ChannelConfigSchema(
        ...
        fields=[
            ConfigField("botToken", "Bot Token", required=True, sensitive=True, validation_pattern=r"^xoxb-.+$"),
            ConfigField("appToken", "App Token", required=True, sensitive=True, validation_pattern=r"^xapp-.+$"),
        ],
    ),
    ...
    "whatsapp": ChannelConfigSchema(
        ...
        fields=[
            ConfigField("phoneNumber", "Phone Number", description="WhatsApp phone number (optional)"),
        ],
    ),
    "irc": ChannelConfigSchema(
        ...
        fields=[
            ...
            ConfigField("channel", "Channel", required=True, description="IRC channel (e.g. #mychannel)"),
